...
class TestReport(common.TestSurveyCommon):
    ...
    def test_report(self):
        ...
        self.assertEqual(sheet.cell(2, 5).value, "2022-04-26")
        self.assertFalse(sheet.cell(3, 5).value)
        self.assertEqual(sheet.cell(2, 6).value, "FIRST")
        self.assertEqual(sheet.cell(3, 6).value, "SECOND")
